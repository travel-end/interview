 ...
 * */
public class AnimBgLayout extends RelativeLayout {
    ...
    public AnimBgLayout(Context context) {
        this(context, null);
    }

    public AnimBgLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public AnimBgLayout(Context context, AttributeSet attrs, int
            defStyleAttr) {
    ...
    private void initLayerDrawable() {
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.LOLLIPOP) {
            backgroundDrawable = getContext().getDrawable(R.drawable.shape_bg_round_white_5);
        }
    ...
    private void initObjectAnimator() {
        ...
        objectAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                AnimBgLayout.this.setBackground(layerDrawable);
            }
        });
