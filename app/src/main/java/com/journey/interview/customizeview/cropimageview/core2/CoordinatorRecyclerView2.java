 ...
 * @Description
 */
public class CoordinatorRecyclerView2 extends RecyclerView {
    ...
    public CoordinatorRecyclerView2(@NonNull Context context) {
        this(context, null);
    }

    public CoordinatorRecyclerView2(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CoordinatorRecyclerView2(@NonNull Context context, @Nullable AttributeSet attrs, int defStyle) {
