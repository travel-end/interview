...
public class ScrollParallaxView2 extends AppCompatImageView implements
    ...
    public ScrollParallaxView2(Context context) {
        this(context, null);
    }

    public ScrollParallaxView2(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ScrollParallaxView2(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);

        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.ScrollParallaxView2);
        mParallaxRate = ta.getFloat(R.styleable.ScrollParallaxView2_parallaxRate, DEFAULT_PARALLAX_RATE);
        mIsParallax = ta.getBoolean(R.styleable.ScrollParallaxView2_enableParallax, true);
        mIsCircle = ta.getBoolean(R.styleable.ScrollParallaxView2_enableCircle, false);
        mRoundWidth = ta.getDimensionPixelSize(R.styleable.ScrollParallaxView2_roundWidth, 0);
        mOutRoundColor = ta.getColor(R.styleable.ScrollParallaxView2_outRoundColor, Color.WHITE);
        ta.recycle();
     ...
     * @return
     */
    public ScrollParallaxView2 setParallaxRate(int rate) {
        if (rate < 0) {
            rate = 0;
        }
     ...
     * @return
     */
    public ScrollParallaxView2 setParallax(boolean parallax) {
