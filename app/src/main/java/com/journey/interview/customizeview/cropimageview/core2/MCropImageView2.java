 ...
 * @Description
 */
public class MCropImageView2 extends AppCompatImageView implements ViewTreeObserver.OnGlobalLayoutListener {
    // 手势帮助类
    ...
    public MCropImageView2(Context context) {
        this(context, null);
    }

    public MCropImageView2(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MCropImageView2(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
