...
public class CommonTabLayout extends FrameLayout implements ValueAnimator.AnimatorUpdateListener {
    ...
    private ArrayList<CustomTab> mTabEntitys = new ArrayList<>();
    ...
    public void setTabData(ArrayList<CustomTab> tabEntitys) {
    ...
    /** 关联数据支持同时切换fragments */
    public void setTabData(ArrayList<CustomTab> tabEntitys, FragmentActivity fa, int containerViewId, ArrayList<Fragment> fragments) {
    ...
    public void notifyDataSetChanged() {
        ...
        for (int i = 0; i < mTabCount; i++) {
            if (mIconGravity == Gravity.START) {
                tabView = View.inflate(mContext, R.layout.common_tab_left, null);
            } else if (mIconGravity == Gravity.END) {
                tabView = View.inflate(mContext, R.layout.common_tab_right, null);
            } else if (mIconGravity == Gravity.BOTTOM) {
                tabView = View.inflate(mContext, R.layout.common_tab_bottom, null);
            } else {
                tabView = View.inflate(mContext, R.layout.common_tab_top, null);
            }
...
//            tv_tab_title.setPadding((int) mTabPadding, 0, (int) mTabPadding, 0);
            ...
            if (mIconVisible) {
                ...
                CustomTab tabEntity = mTabEntitys.get(i);
