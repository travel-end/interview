 ...
 * 歌单广场的3个推荐歌单的Pager
 */
public class ScrollBannerPager extends ViewGroup {
    private static final String TAG = "ScrollBannerPager";
    ...
    public ScrollBannerPager(Context context) {
        this(context, null);
    }

    public ScrollBannerPager(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ScrollBannerPager(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private int measureWidth(int widthMeasureSpec) {
        ...
        if (widthMode == MeasureSpec.EXACTLY) {
            ...
            for (int i = 0; i < getChildCount(); i++) {
                ScrollBannerLayoutParams lp = (ScrollBannerLayoutParams) getChildAt(i).getLayoutParams();
    ...
    private int measureHeight(int heightMeasureSpec) {
        ...
        if (heightMode == MeasureSpec.EXACTLY) {
            ...
            for (int i = 0; i < getChildCount(); i++) {
                ...
                ScrollBannerLayoutParams lp = (ScrollBannerLayoutParams) child.getLayoutParams();
    ...
    private int calBaseLine(int index) {
        ...
        ScrollBannerLayoutParams lp = (ScrollBannerLayoutParams) getChildAt(index).getLayoutParams();
     ...
     */
    public static class ScrollBannerLayoutParams extends MarginLayoutParams {
        float scale = 0f;
        float alpha = 0f;
        int from;
        int to;
        ...
        public ScrollBannerLayoutParams(Context c, AttributeSet attrs) {
            super(c, attrs);
        }

        public ScrollBannerLayoutParams(int width, int height) {
            super(width, height);
        }

        public ScrollBannerLayoutParams(ViewGroup.LayoutParams source) {
            super(source);
        }
    }
    ...
    public LayoutParams generateLayoutParams(AttributeSet attrs) {
        return new ScrollBannerLayoutParams(mContext, attrs);
    }

    @Override
    protected LayoutParams generateLayoutParams(LayoutParams p) {
        return new ScrollBannerLayoutParams(p);
    }

    @Override
    protected LayoutParams generateDefaultLayoutParams() {
        return new ScrollBannerLayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT);
    }
    ...
    public void addView(View child, int index, LayoutParams params) {
        ScrollBannerLayoutParams lp;
        if (params instanceof ScrollBannerLayoutParams) {
            lp = (ScrollBannerLayoutParams) params;
        } else {
            lp = new ScrollBannerLayoutParams(params);
        }
        if (getChildCount() < 2) {
            ...
            for (int i = getChildCount() - 1; i >= 0; i--) {
                ...
                if (isPointInView(clickView, points)) {
                    ...
                    if (indexOfChild(clickView) != 2) {
                        ...
                        ScrollBannerLayoutParams lp = (ScrollBannerLayoutParams) clickView.getLayoutParams();
