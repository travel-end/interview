//package com.journey.interview.customizeview.rectcoverview
//
...
// * @Description
// */
//class RectCoverView(context: Context, attrs: AttributeSet) : View(context, attrs) {
//
...
//        val ta = context.obtainStyledAttributes(attrs, R.styleable.RectCoverView)
//        mPadding = ta.getDimension(R.styleable.RectCoverView_roundPadding, 40.dp)
//        mRoundCorner = ta.getDimension(R.styleable.RectCoverView_roundCorner, 10.dp)
//        mCoverColor = ta.getColor(R.styleable.RectCoverView_roundCoverColor, "#99000000".toColorInt())
//
//        ta.recycle()
//
//    }
