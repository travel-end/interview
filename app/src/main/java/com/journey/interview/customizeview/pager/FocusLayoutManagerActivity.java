...
public class FocusLayoutManagerActivity extends AppCompatActivity {
    ...
    int horRes[] = {R.drawable.cover10, R.drawable.ic_wel_bg, R.drawable.cover10, R.drawable.ic_wel_bg, R.drawable.cover10,
            R.drawable.ic_wel_bg, R.drawable.cover10, R.drawable.ic_wel_bg, R.drawable.cover10, R.drawable.ic_wel_bg,
            R.drawable.cover10, R.drawable.ic_wel_bg, R.drawable.ic_wel_bg, R.drawable.cover10, R.drawable.ic_wel_bg,
            R.drawable.cover10, R.drawable.ic_wel_bg, R.drawable.cover10, R.drawable.ic_wel_bg, R.drawable.cover10};
    int verRes[] = {R.drawable.cover3, R.drawable.cover9, R.drawable.cover3, R.drawable.cover9, R.drawable.cover3,
            R.drawable.cover9, R.drawable.cover3, R.drawable.cover9, R.drawable.cover3, R.drawable.cover9};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_focus_layoutmanager);
            ...
            public ViewHolder(@NonNull final View itemView) {
                ...
                itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (mToast == null) {
                            mToast = Toast.makeText(FocusLayoutManagerActivity.this, "" + pos,
                                    Toast.LENGTH_SHORT);
                        }
                        mToast.setText("" + pos);
                        mToast.show();
