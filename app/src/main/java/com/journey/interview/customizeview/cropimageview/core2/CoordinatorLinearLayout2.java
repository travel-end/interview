 ...
 * @Description
 */
public class CoordinatorLinearLayout2 extends LinearLayout {
    // 是否展开
    ...
    public CoordinatorLinearLayout2(Context context) {
        this(context, null);
    }

    public CoordinatorLinearLayout2(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CoordinatorLinearLayout2(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
