...
public class HeartView2 extends View {
    ...
    public HeartView2(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public HeartView2(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        //关闭硬件加速
        setLayerType(LAYER_TYPE_SOFTWARE, null);

        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.HeartView2);
        mDuration = ta.getInteger(R.styleable.HeartView2_heartDuration, DURATION_TIME);
        mAlphaEnable = ta.getBoolean(R.styleable.HeartView2_heartEnableAlpha, true);
        mScaleEnable = ta.getBoolean(R.styleable.HeartView2_heartEnableScale, true);
        ta.recycle();
